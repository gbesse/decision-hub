...
Hosting declares the logical D1 binding as `DB`, matching the platform contract. Four bounded real Jev calls across the launch apps passed (two through this Worker); details contain synthetic inputs only in `docs/live-verification.json`.
